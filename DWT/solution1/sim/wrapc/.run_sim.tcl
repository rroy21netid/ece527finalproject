...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "DWT_Accel.autotvin.dat"
	set constFileTvOut       "DWT_Accel.autotvout.dat"
	set constFileHdlTvIn     "DWT_Accel.autohdltvin.dat"
	set constFileHdlTvOut    "DWT_Accel.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"

...
$(ObjDir)/DWT_Accel_TB.c_pre.c.tb.o : DWT_Accel_TB.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) DWT_Accel_TB.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/DWT_Accel.c_pre.c.tb.o : DWT_Accel.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) DWT_Accel.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

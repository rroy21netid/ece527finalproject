...
//------------------------Parameter----------------------
`define TV_IN_DATA_B "../tv/cdatafile/c.DWT_Accel.autotvin_DATA_B.dat"
`define TV_OUT_DATA_B "../tv/rtldatafile/rtl.DWT_Accel.autotvout_DATA_B.dat"
...
parameter DATA_B_C_DATA_BITWIDTH = 32'd 8;
parameter DATA_B_mem_depth = 32'd 307200;
...
output [32 - 1 : 0] TRAN_DATA_B_b_0;
output [32 - 1 : 0] TRAN_DATA_B_b_1;
output [32 - 1 : 0] TRAN_DATA_B_b_2;
output [32 - 1 : 0] TRAN_DATA_B_b_3;
output [32 - 1 : 0] TRAN_DATA_B_b_4;
output [32 - 1 : 0] TRAN_DATA_B_b_5;
output [32 - 1 : 0] TRAN_DATA_B_b_6;
output [32 - 1 : 0] TRAN_DATA_B_b_7;
input ready;
input done;
...
assign    TRAN_DATA_B_b_0 = b_0;
assign    TRAN_DATA_B_b_1 = b_1;
assign    TRAN_DATA_B_b_2 = b_2;
assign    TRAN_DATA_B_b_3 = b_3;
assign    TRAN_DATA_B_b_4 = b_4;
assign    TRAN_DATA_B_b_5 = b_5;
assign    TRAN_DATA_B_b_6 = b_6;
assign    TRAN_DATA_B_b_7 = b_7;
...
initial begin : initialize_offset
  ...
  b_0 <= 0 * DATA_byte_num;
  b_1 <= 38400 * DATA_byte_num;
  b_2 <= 76800 * DATA_byte_num;
  b_3 <= 115200 * DATA_byte_num;
  b_4 <= 153600 * DATA_byte_num;
  b_5 <= 192000 * DATA_byte_num;
  b_6 <= 230400 * DATA_byte_num;
  b_7 <= 268800 * DATA_byte_num;
end
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > DATA_B_mem_depth) begin
                $display ("C:/Users/ronal/Documents/ECE527MPs/final_project/DWT/solution1/sim/verilog/AESL_axi_master_DATA_B.v: Write request address %d exceed AXI master DATA_B array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, DATA_B_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > DATA_B_mem_depth) begin
                $display ("C:/Users/ronal/Documents/ECE527MPs/final_project/DWT/solution1/sim/verilog/AESL_axi_master_DATA_B.v: Read request address %d exceed AXI master DATA_B array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, DATA_B_mem_depth); 
                $finish;
            end
...
initial begin : write_file_proc 
  ...
  integer mem_page; 
  integer DATA_B_bitwidth; 
  reg [DATA_B_C_DATA_BITWIDTH - 1 : 0] mem_tmp; 
  reg [DATA_B_DATA_BITWIDTH - 1 : 0] tmp_data;
  transaction_num = 0; 
  DATA_B_bitwidth = DATA_B_C_DATA_BITWIDTH; 
  count_seperate_factor_by_bitwidth (DATA_B_bitwidth , factor);
  while(1) begin 
      ...
      mem_page = transaction_num % mem_page_num ;
      # 0.1;
      fp = $fopen(`TV_OUT_DATA_B, "a"); 
      if(fp == 0) begin       // Failed to open file 
          $display("Failed to open file \"%s\"!", `TV_OUT_DATA_B); 
          $finish; 
      end 
      $fdisplay(fp, "[[transaction]] %d", transaction_num);
      for(i = 0; i < (DATA_B_mem_depth - DATA_B_mem_depth % factor); i = i + 1) begin 
          if (factor == 4) begin
              case(mem_page)
                  0 : tmp_data = DATA_B_mem_0[i/factor];
                  1 : tmp_data = DATA_B_mem_1[i/factor];
                  2 : tmp_data = DATA_B_mem_2[i/factor];
          ...
          if (factor == 1) begin
              case(mem_page)
                  0 : mem_tmp = DATA_B_mem_0[i];
                  1 : mem_tmp = DATA_B_mem_1[i];
                  2 : mem_tmp = DATA_B_mem_2[i];
                  default: $display("The page_num of write file is not valid!");
              endcase
              $fdisplay(fp,"0x%x",mem_tmp);
          end
      ...
      if (factor == 4) begin
          case(mem_page)
              0 : tmp_data = DATA_B_mem_0[DATA_B_mem_depth/factor];
              1 : tmp_data = DATA_B_mem_1[DATA_B_mem_depth/factor];
              2 : tmp_data = DATA_B_mem_2[DATA_B_mem_depth/factor];
              default: $display("The page_num of write file is not valid!");
          endcase
          if ((DATA_B_mem_depth - 1) % factor == 2) begin
              $fdisplay(fp,"0x%x",tmp_data[7:0]);
              $fdisplay(fp,"0x%x",tmp_data[15:8]);
              $fdisplay(fp,"0x%x",tmp_data[23:16]);
          end
          if ((DATA_B_mem_depth - 1) % factor == 1) begin
              $fdisplay(fp,"0x%x",tmp_data[7:0]);
              $fdisplay(fp,"0x%x",tmp_data[15:8]);
          end
          if ((DATA_B_mem_depth - 1) % factor == 0) begin
              $fdisplay(fp,"0x%x",tmp_data[7:0]);
          end
      end
      if (factor == 2) begin
          if ((DATA_B_mem_depth - 1) % factor == 0) begin
              case(mem_page)
                  0 : $fdisplay(fp,"0x%x",DATA_B_mem_0[DATA_B_mem_depth/factor][15:0]);
                  1 : $fdisplay(fp,"0x%x",DATA_B_mem_1[DATA_B_mem_depth/factor][15:0]);
                  2 : $fdisplay(fp,"0x%x",DATA_B_mem_2[DATA_B_mem_depth/factor][15:0]);
                  default: $display("The page_num of write file is not valid!");
              endcase
          end
      end

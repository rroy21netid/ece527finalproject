...
#(parameter
    ...
    output wire [31:0]                   c_0,
    output wire [31:0]                   c_1,
    output wire [31:0]                   c_2,
    output wire [31:0]                   c_3,
    output wire [31:0]                   c_4,
    output wire [31:0]                   c_5,
    output wire [31:0]                   c_6,
    output wire [31:0]                   c_7
);
//------------------------Address Info-------------------
...
localparam
    ...
    ADDR_A_0_CTRL   = 8'h14,
    ADDR_A_1_DATA_0 = 8'h18,
    ADDR_A_1_CTRL   = 8'h1c,
    ADDR_A_2_DATA_0 = 8'h20,
    ADDR_A_2_CTRL   = 8'h24,
    ADDR_A_3_DATA_0 = 8'h28,
    ADDR_A_3_CTRL   = 8'h2c,
    ADDR_A_4_DATA_0 = 8'h30,
    ADDR_A_4_CTRL   = 8'h34,
    ADDR_A_5_DATA_0 = 8'h38,
    ADDR_A_5_CTRL   = 8'h3c,
    ADDR_A_6_DATA_0 = 8'h40,
    ADDR_A_6_CTRL   = 8'h44,
    ADDR_A_7_DATA_0 = 8'h48,
    ADDR_A_7_CTRL   = 8'h4c,
    ADDR_B_0_DATA_0 = 8'h50,
    ADDR_B_0_CTRL   = 8'h54,
    ADDR_B_1_DATA_0 = 8'h58,
    ADDR_B_1_CTRL   = 8'h5c,
    ADDR_B_2_DATA_0 = 8'h60,
    ADDR_B_2_CTRL   = 8'h64,
    ADDR_B_3_DATA_0 = 8'h68,
    ADDR_B_3_CTRL   = 8'h6c,
    ADDR_B_4_DATA_0 = 8'h70,
    ADDR_B_4_CTRL   = 8'h74,
    ADDR_B_5_DATA_0 = 8'h78,
    ADDR_B_5_CTRL   = 8'h7c,
    ADDR_B_6_DATA_0 = 8'h80,
    ADDR_B_6_CTRL   = 8'h84,
    ADDR_B_7_DATA_0 = 8'h88,
    ADDR_B_7_CTRL   = 8'h8c,
    ADDR_C_0_DATA_0 = 8'h90,
    ADDR_C_0_CTRL   = 8'h94,
    ADDR_C_1_DATA_0 = 8'h98,
    ADDR_C_1_CTRL   = 8'h9c,
    ADDR_C_2_DATA_0 = 8'ha0,
    ADDR_C_2_CTRL   = 8'ha4,
    ADDR_C_3_DATA_0 = 8'ha8,
    ADDR_C_3_CTRL   = 8'hac,
    ADDR_C_4_DATA_0 = 8'hb0,
    ADDR_C_4_CTRL   = 8'hb4,
    ADDR_C_5_DATA_0 = 8'hb8,
    ADDR_C_5_CTRL   = 8'hbc,
    ADDR_C_6_DATA_0 = 8'hc0,
    ADDR_C_6_CTRL   = 8'hc4,
    ADDR_C_7_DATA_0 = 8'hc8,
    ADDR_C_7_CTRL   = 8'hcc,
    WRIDLE          = 2'd0,
    WRDATA          = 2'd1,
    WRRESP          = 2'd2,

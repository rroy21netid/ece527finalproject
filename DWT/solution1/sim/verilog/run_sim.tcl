...
if {[file isfile DWT_Accel.autotvin.dat]} {
	file delete -force DWT_Accel.autotvin.dat
}

if {[file isfile DWT_Accel.autotvout.dat]} {
	file delete -force DWT_Accel.autotvout.dat
}

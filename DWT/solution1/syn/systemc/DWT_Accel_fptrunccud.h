...
// ==============================================================
#ifndef __DWT_Accel_fptrunccud__HH__
#define __DWT_Accel_fptrunccud__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(DWT_Accel_fptrunccud) {
    ...
    SC_CTOR(DWT_Accel_fptrunccud):  ACMP_fptrunc_U ("ACMP_fptrunc_U") {

...
// ==============================================================
#ifndef __DWT_Accel_dcmp_64g8j__HH__
#define __DWT_Accel_dcmp_64g8j__HH__
#include "ACMP_dcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(DWT_Accel_dcmp_64g8j) {
    ...
    SC_CTOR(DWT_Accel_dcmp_64g8j):  ACMP_dcmp_U ("ACMP_dcmp_U") {
        ACMP_dcmp_U.clk(clk);

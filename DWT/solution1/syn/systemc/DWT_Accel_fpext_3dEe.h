...
// ==============================================================
#ifndef __DWT_Accel_fpext_3dEe__HH__
#define __DWT_Accel_fpext_3dEe__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(DWT_Accel_fpext_3dEe) {
    ...
    SC_CTOR(DWT_Accel_fpext_3dEe):  ACMP_fpext_U ("ACMP_fpext_U") {

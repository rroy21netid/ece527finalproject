...
// ==============================================================
#ifndef __DWT_Accel_sitodp_hbi__HH__
#define __DWT_Accel_sitodp_hbi__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(DWT_Accel_sitodp_hbi) {
    ...
    SC_CTOR(DWT_Accel_sitodp_hbi):  ACMP_sitodp_U ("ACMP_sitodp_U") {

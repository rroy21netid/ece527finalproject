...
// ==============================================================
#ifndef __DWT_Accel_dadddsueOg__HH__
#define __DWT_Accel_dadddsueOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(DWT_Accel_dadddsueOg) {
    ...
    SC_CTOR(DWT_Accel_dadddsueOg):  ACMP_dadddsub_U ("ACMP_dadddsub_U") {

...
// ==============================================================
#ifndef __DWT_Accel_uitofp_bkb__HH__
#define __DWT_Accel_uitofp_bkb__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(DWT_Accel_uitofp_bkb) {
    ...
    SC_CTOR(DWT_Accel_uitofp_bkb):  ACMP_uitofp_U ("ACMP_uitofp_U") {

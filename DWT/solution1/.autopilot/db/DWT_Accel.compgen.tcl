...
set ID 132
set hasByteEnable 0
set MemName DWT_Accel_A_buffelbW
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 133 \
			corename DWT_Accel_CTL_axilite \
			name DWT_Accel_CTL_s_axi \
			ports {$port_CTL} \
			op interface \
			is_flushable 0 \ 
		} "
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler DWT_Accel_CTL_s_axi
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler DWT_Accel_DATA_A_m_axi
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler DWT_Accel_DATA_B_m_axi
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler DWT_Accel_DATA_C_m_axi
}
